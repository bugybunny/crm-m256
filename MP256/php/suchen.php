...
$output .=  '<table id="tabelle" cellpadding="0" cellspacing="0" width="960px">
				...
				<tr id="auswertung_header">
					<th><input type="text" id="suche_betreff" onkeyup="search(\'betreff\', this.value)" /></th>
					<th><input type="text" id="suche_kunde" onkeyup="search(\'kunde\', this.value)" /></th>
					<th><input type="text" id="suche_supporter" onkeyup="search(\'supporter\', this.value)" /></th>
